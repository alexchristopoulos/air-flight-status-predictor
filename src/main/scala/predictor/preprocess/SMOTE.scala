...
class SMOTE extends Transformer with DefaultParamsWritable{
  ...
  def setfeatureParam(value: String): this.type = set(featureParam, value)
  def setlabelParam(value: String): this.type = set(labelParam, value)
  def setpercentOverParam(value: Int): this.type = set(percentOverParam, value)
  def setBucketLengthParam(value: Int): this.type = set(BucketLengthParam, value)
  def setNumHashTablesParam(value: Int): this.type = set(NumHashTablesParam, value)
